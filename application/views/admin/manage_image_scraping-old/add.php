...
{	
    ...
    //alert(form_data);                             
    $.ajax({
		url: "<?= base_url()?>admin/manage_image_scraping/upload_import_file/?headername="+headername+"&itemname="+itemname+"&itemprice="+itemprice+"&itemintro1="+itemintro1+"&itemintro2="+itemintro2+"&image1="+image1+"&image2="+image2+"&image3="+image3+"&image4="+image4,
		//dataType: 'text',
		cache: false,
		contentType: false,
		processData: false,
