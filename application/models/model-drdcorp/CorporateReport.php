...
class CorporateReport extends CI_Model
{
    ...
    public function get_body($report_type,$email,$code,$compcode,$division,$name,$company_name,$file1,$file2,$file3,$file_attachment,$from_date,$to_date,$folder_date,$file_name) {
		...
		$this->SendEmail($email,$subject,$message,$code,$file_attachment,$file_attachment1,$file_attachment2,$file_attachment3,$file_name);
	}

	public function SendEmail($user_email,$subject,$message,$code,$file_attachment,$file_attachment1,$file_attachment2,$file_attachment3,$file_name)
	{
		$message_status = "Error: file name not found!";
		try{
			if(!empty($file_name)){
