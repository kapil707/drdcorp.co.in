...
class Manage_user_type extends CI_Controller {
	public $Page_title = "Manage User Type";
	public $Page_name  = "manage_user_type";
	public $Page_view  = "manage_user_type";
	public $Page_menu  = "manage_user_type";
	public $page_controllers = "manage_user_type";
	public $Page_tbl   = "tbl_user_type";
