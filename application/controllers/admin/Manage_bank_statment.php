...
class Manage_bank_statment extends CI_Controller {
	...
	public function view()
	{
		...
		$query = $this->BankModel->select_query("SELECT s.*,p.final_chemist as chemist_id,p.invoice_text as invoice_number,p.download_easysol as download_easysol,p.checkbox_done_status as checkbox_done_status,p.id as pid from tbl_statment as s left JOIN tbl_bank_processing as p on p.upi_no=s.customer_reference where s.date BETWEEN '$start_date' AND '$end_date'");
