...
class Profile_management extends CI_Controller {
	public $Page_title = "Profile Management";
	public $Page_name  = "profile_management";
	public $Page_view  = "profile_management";
	public $Page_menu  = "profile_management";
	public $Page_tbl   = "tbl_permission_settings";
	public $page_controllers = "profile_management";
